...
<body class="h-screen w-screen p-0">
    ...
    <div class="grid grid-cols-3 md:mt-36 mt-14">
        <div class="md:col-span-2 col-span-3 h-full text-black justify-center flex items-end flex-col">
            <div class="w-11/12 mt-0 mb-10">
                <div class="md:text-5xl text-2xl font-bold mt-10 mb-10">PREGUNTAS FRECUENTES</div>
            ...
            <div class="w-11/12 mt-20 mb-48">
                <div class="md:text-5xl text-2xl font-bold mt-10 mb-10">ENVÍOS Y METODOS DE PAGO</div>
                <div class="md:ml-10 h-56">
                    <div class="mt-3">
                        <details>
        ...
        <div class="md:col-span-1 col-span-3 flex justify-end md:mt-0 mt-10">
            <img src="assets/media/img/questions.png" alt="" width="450px">
        </div>
    </div>
